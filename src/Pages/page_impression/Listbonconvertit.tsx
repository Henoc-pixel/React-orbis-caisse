...
const Listbonconvertit: React.FC = () => {
  ...
  const fetchbonMission = useCallback(async () => {
    try {
      ...
      const filteredData = data.filter((item) => item.statut === "convertit");
                  ...
                  <tr key={bon.id}>
                    ...
                    <td className="text-center align-middle">
                      <Button
                        ...
                        size="sm"
                        onClick={() =>
                          navigate(`/Read-bon-convertit/${bon.id}`)
                        }
                      >
                        <FaEye size={20} />
                      </Button>
...
export default Listbonconvertit;
