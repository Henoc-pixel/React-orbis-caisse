...
const Homeattente = () => {
  ...
  const fetchBesoin = useCallback(async () => {
    try {
      ...
      // Filtrer les besoins pour ne conserver que ceux ayant le statut "en attente"
      const filteredData = data.filter((item) => item.statut === "en attente");
