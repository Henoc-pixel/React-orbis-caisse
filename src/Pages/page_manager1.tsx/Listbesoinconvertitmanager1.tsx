  ...
  return (
    <Card className="shadow w-100">
      <Card.Header className="text-white bg-primary">
        <h6 className="mb-0">Liste des fiches de besoin convertit</h6>
      </Card.Header>
      <Card.Body>
                  ...
                  <tr key={besoin.id}>
                    ...
                    <td className="text-center align-middle">
                      <Button
                        ...
                        size="sm"
                        onClick={() =>
                          navigate(`/Read-besoin-convertit-M/${besoin.id}`)
                        }
                      >
                        <FaEye size={20} />
                      </Button>
...
export default Homeconvertitmanager1;
