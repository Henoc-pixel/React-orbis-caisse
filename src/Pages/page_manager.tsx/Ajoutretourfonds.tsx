...
const createJournalEntryForRetourFonds = async (
  ...
  try {
    ...
    const caisseCode = caisse.code; // Supposons que le code est "C001" ou "C002"
...
const AjoutRetourFond: React.FC = () => {
  ...
  // Options pour les types de dépense
  ...
  useEffect(() => {
    ...
    const fetchInitialData = async () => {
      ...
      try {
        ...
        // Trouver la caisse de l'utilisateur connecté
  ...
  // Mettre à jour les options de référence lorsque le type de dépense change
  useEffect(() => {
  ...
  // Mettre à jour le montant sortie lorsque la référence change
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    // Vérifier si la référence a déjà un retour de fonds
